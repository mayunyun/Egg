...
//            //判断是否连接网络
//            if (![HNANetworkHelper isConnectedToNetwork]) {
//                [self showAlertViewWithTitle:@"" message:@"网络连接链接异常，请检查网络设置" buttonArray:nil cancelButton:@"确定"buttonEvent:^(NSInteger buttonIndex) {
//                }];
//            }
//            break;
//        }
...
- (void)rightBarTitleButtonTarget:(id)target action:(SEL)action text:(NSString*)str textColor:(UIColor*)textColor{
    ...
    [rightBarBtn setTitleColor:textColor forState:UIControlStateNormal];
