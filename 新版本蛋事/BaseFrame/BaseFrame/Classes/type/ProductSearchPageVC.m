...
//    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc]initWithImage:[UIImage imageNamed:@"search"] style:UIBarButtonItemStylePlain target:self action:@selector(gouwuche)];
...
- (UISearchBar *)searchview{
    if (_search == nil) {
        ...
        //加上 搜索栏
        _search = [[HXSearchBar alloc] initWithFrame:CGRectMake(0, 0, mScreenWidth - 100, 30)];
