...
@interface MYYMineCollectViewController ()<UICollectionViewDataSource,UICollectionViewDelegate>
{
 ...
 */
    ...
    [HTNetWorking postWithUrl:@"collect?action=searchCollection" refreshCache:YES  params:nil success:^(id response) {
