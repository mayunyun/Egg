...
- (UITableView*)tbView{
    if (_tbView == nil) {
        _tbView = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, kScreen_Width, 20*2+45*2+142) style:UITableViewStylePlain];
...
- (void)nextBtnClick:(UIButton*)sender{
    ...
    if (cell.selectBtn1.selected) {
        ...
        money = @"500";
    }else if (cell.selectBtn5.selected) {
        money = @"800";
    }else if (cell.selectBtn6.selected) {
        money = @"1000";
    }
