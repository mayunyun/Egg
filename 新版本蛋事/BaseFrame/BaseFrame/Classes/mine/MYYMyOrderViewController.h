...
@interface MYYMyOrderViewController : BaseViewController<MYYMyOrderHeaderTitleViewDelegate,UIScrollViewDelegate>
//头部的选项卡
@property(nonatomic,strong) MYYMyOrderHeaderTitleView *titleView;
