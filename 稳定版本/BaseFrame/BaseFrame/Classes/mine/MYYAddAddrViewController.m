...
- (void)nextBtnClick:(UIButton*)sender{
    ...
    if (IsEmptyValue(_provinceid)||IsEmptyValue(_cityid)||IsEmptyValue(_countryid)||[textField.text isEqualToString:@""]||IsEmptyValue(_xiaoquid)||[textField.text isEqualToString:@"请输入详细地址"]) {
 ...
 */
    ...
    NSDictionary* params = @{@"data":[NSString stringWithFormat:@"{\"id\":\"%@\",\"provinceid\":\"%@\",\"cityid\":\"%@\",\"areaid\":\"%@\",\"villageid\":\"%@\",\"address\":\"%@\",\"isdefault\":\"%@\"}",self.addrModel.Id,_provinceid,_cityid,_countryid,_xiaoquid,textField.text,defaultStr]};
    //NSLog(@"%@",params);
...
//        defaultStr = @"0";
//    }
    NSDictionary* params = @{@"data":[NSString stringWithFormat:@"{\"provinceid\":\"%@\",\"cityid\":\"%@\",\"areaid\":\"%@\",\"villageid\":\"%@\",\"address\":\"%@\",\"isdefault\":\"1\"}",_provinceid,_cityid,_countryid,_xiaoquid,textField.text]};
