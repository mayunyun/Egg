...
- (void)shopButtonView{
    ...
    UIButton *goShop = [[UIButton alloc]initWithFrame:CGRectMake(mScreenWidth/2, mScreenHeight-50-64, mScreenWidth/2, 50)];
    ...
    UIButton *Shopcar = [[UIButton alloc]initWithFrame:CGRectMake(0, mScreenHeight-50-64, mScreenWidth/2, 50)];
