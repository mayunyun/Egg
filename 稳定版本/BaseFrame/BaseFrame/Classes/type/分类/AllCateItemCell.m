...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        self.backgroundColor = UIColorFromRGB(0xEDEEEF);
        ...
        _container.backgroundColor = UIColorFromRGB(0xEDEEEF);
        ...
        _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 5, containerW - 10, containerH - 10)];
...
- (void)setCateModel:(SecondaryCateModel *)cateModel
{
    ...
    _titleLabel.text = cateModel.proname;
}
