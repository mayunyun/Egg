...
- (void)setupCollectionView {
    ...
    UIView * allProView = [[UIView alloc]initWithFrame:CGRectMake(0, 20, ScreenWidth, 60)];
    ...
    UIImageView * rightArrow = [[UIImageView alloc]initWithFrame:CGRectMake(SCREEN_WIDTH-24, 11, 14, 18)];
    rightArrow.image = [UIImage imageNamed:@"iconfont-arrow"];
    [allLabel addSubview:rightArrow];
    ...
    _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 80, SCREENWIDTH, SCREENHEIGHT-80 ) collectionViewLayout:layout];
